...
public interface ArenaSettings {
	...
	/**
	 * Is health regen disabled?
	 *
	 * @return
	 */
	boolean disableHealthRegen();

	/**
	 * The delay before the arena fires end/finish commands.
	 * 
	 * @return
	 */
	SimpleTime getEndCommandsDelay();
	 ...
	 * @return the commands.
	 */
	ArenaCommands getPhaseStartCommands();
	 ...
	 * @return the commands.
	 */
	ArenaCommands getLastPhaseCommands();
