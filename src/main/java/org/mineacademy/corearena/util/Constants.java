...
public final class Constants {
	...
	public static final class Symbols {
		...
		public static final String[] POWER_SIGN_FORMAT = {
				"[&lPower&r]",
				"{type}"
		};
	}
	...
	public static final class Items {
		public static final String EXP_ITEM_TAG = "CoreArena_ExpDrop";
		public static final ItemStack MENU_FILLER = ItemCreator.fromMaterial(CompMaterial.fromLegacy("STAINED_GLASS_PANE", 8)).name(" ").make();
		public static final ItemStack DEFAULT_ICON = new ItemStack(CompMaterial.WHITE_STAINED_GLASS.getMaterial());
	}

	public static final class Header {
		public static final String[] ARENA_FILE = {
				" -------------------------------------------------------",
		...
		public static final String[] UPGRADE_FILE = {
				" -------------------------------------------------------",
